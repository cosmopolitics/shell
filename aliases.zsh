...
#cd/ aliases
alias comp='cd ~/Downloads/apcompsci'
alias blog="cd ~/Downloads/apcompsci/'first website'/blog"
alias home='cd ~'
alias etc='cd /etc/'
...
alias pcode='cd ~/pcode'
alias nvimconf='cd ~/.config/nvim'

#backlight
alias backdim='backlight_control 1'
alias backlhigh='backlight_control 100'
